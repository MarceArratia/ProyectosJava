	...
	<div id="container">
		...
		<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
			<ul class="navbar-nav">
				...
				<li class="nav-item"><a class="nav-link" href="horospoco.jsp">CONSULTAR ANIMAL ZODIACAL</a></li>
			...
			<div id="content" style="margin: 5%">
				...
				<div class="card">
					<div class="card-body">
						...
						<form action="busquedaZodiaco" method="get">
							<div class="form-group">
								<label for="nombre">Año de nacimiento</label> <input type="text"
				...
				<div class="card">
					<div class="card-body">
						...
						<div class="form-group">
								...
								<input type="text" class="form-control" name="animal" value="<%= zodiaco.getNombreAnimal()%>" >
						</div>
						<div class="form-group">
								<label for="nombre">Descripcion</label> 
								<textarea class="form-control" id="descripcion" rows="3">
									<%= zodiaco.getDescripcion()%>
								</textarea>
						</div>
					</div>
				</div>
