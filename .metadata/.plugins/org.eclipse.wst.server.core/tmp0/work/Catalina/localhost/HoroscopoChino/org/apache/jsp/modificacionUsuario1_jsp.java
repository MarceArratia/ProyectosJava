 ...
 * Generated at: 2020-08-06 00:41:11 UTC
...
public final class modificacionUsuario1_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	//	if (request.getAttribute("listaUsuarios") != null) {
      ...
      out.write("\t\t\tstyle=\"margin: 0 auto; border: 1px solid black; width: 600px; margin-top: 50px;\">\r\n");
      out.write("\t\t\t<div id=\"content\" style=\"margin: 5%\">\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t<div class=\"card\">\r\n");
      out.write("\t\t\t\t\t<div class=\"card-body\">\r\n");
      out.write("\t\t\t\t\t<h5 class=\"card-title\">Buscar usuario a modificar</h5>\r\n");
      out.write("\t\t\t\t\t\t<form action=\"ModificacionUsuario\" method=\"post\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<label for=\"nombre\">Nombre Usuario</label> <input type=\"text\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"form-control\" name=\"nombre\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tplaceholder=\"ingrese nombre\">\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<button type=\"submit\" class=\"btn btn-primary\" name=\"modificacion\" value=\"mod\" >Buscar</button>\r\n");
      out.write("\t\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<br>\r\n");
      out.write("\t\t\t\t<div class=\"card\">\r\n");
      out.write("\t\t\t\t\t<div class=\"card-body\">\r\n");
      out.write("\t\t\t\t\t<h5 class=\"card-title\">Usuario encontrado</h5>\r\n");
      out.write("\t\t\t\t\t\t<form action=\"modificacion\" method=\"post\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<label for=\"nombre\">Id Usuario</label> <input type=\"text\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"form-control\" name=\"idUsuario\" value=\"");
      out.print(user.getIdUsuario());
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<label for=\"nombre\">Nombre Completo</label> <input type=\"text\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"form-control\" name=\"nombreCompleto\" value=\"");
      out.print(user.getNombreCompleto());
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<label for=\"correo\">Correo Electronico</label> <input\r\n");
      out.write("\t\t\t\t\t\t\t\t\ttype=\"email\" class=\"form-control\" name=\"correo\" value=\"");
      out.print(user.getDireccionCorreo());
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<label for=\"edad\">Edad</label> <input type=\"number\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"form-control\" name=\"edad\" value=\"");
      out.print(user.getEdad());
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<label for=\"profesion\">Profesion</label> <input type=\"text\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"form-control\" name=\"profesion\" value=\"");
      out.print(user.getProfesion());
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\r\n");
